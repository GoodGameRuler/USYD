...
public class EnemyProjectile implements Renderable, Moveable, Damagable, Projectile, GameObject {
    ...
    private EnemyProjectileStrategy startegy;
    ...
    @Override
    public void update() {
        this.position = this.startegy.behaviour(this.position);
    }

    public EnemyProjectile setStrategy(EnemyProjectileStrategy eps) {
        this.startegy = eps;
        return this;
    }
}
