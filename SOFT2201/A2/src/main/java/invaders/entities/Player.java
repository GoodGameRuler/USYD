...
import invaders.entities.Factories.ConcretePlayerProjectile;
...
public class Player implements Moveable, Damagable, Renderable {
    ...
    public Projectile shoot(){
        if(!this.activeProjectile) {
            ...
            ProjectileCreator pc = new ConcretePlayerProjectile();
            return pc.createProjectile(this.position.clone(0, -10));
        }
        return null;
    }
